...
do
    case $opt in
        "r4s")
            ...
            RELEASE='https://downloads.openwrt.org/releases/23.05.4/targets/rockchip/armv8/openwrt-imagebuilder-23.05.4-rockchip-armv8.Linux-x86_64.tar.xz'
            DIR='openwrt-imagebuilder-23.05.4-rockchip-armv8.Linux-x86_64'
        ...
        "apu2")
            ...
            RELEASE='https://downloads.openwrt.org/releases/23.05.4/targets/x86/64/openwrt-imagebuilder-23.05.4-x86-64.Linux-x86_64.tar.xz'
            DIR='openwrt-imagebuilder-23.05.4-x86-64.Linux-x86_64'
            PROFILE='generic'
            break
          ;;
         "wac124")
            echo "Building image for Netgear WAC124"
            RELEASE='https://downloads.openwrt.org/releases/23.05.4/targets/ramips/mt7621/openwrt-imagebuilder-23.05.4-ramips-mt7621.Linux-x86_64.tar.xz'
            DIR='openwrt-imagebuilder-23.05.4-ramips-mt7621.Linux-x86_64'
