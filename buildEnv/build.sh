...
do
    case $opt in
        "r4s")
            ...
            RELEASE='https://downloads.openwrt.org/releases/24.10.6/targets/rockchip/armv8/openwrt-imagebuilder-24.10.6-rockchip-armv8.Linux-x86_64.tar.zst'
            DIR='openwrt-imagebuilder-24.10.6-rockchip-armv8.Linux-x86_64'
        ...
        "apu2")
            ...
            RELEASE='https://downloads.openwrt.org/releases/24.10.6/targets/x86/64/openwrt-imagebuilder-24.10.6-x86-64.Linux-x86_64.tar.zst'
            DIR='openwrt-imagebuilder-24.10.6-x86-64.Linux-x86_64'
            PROFILE='generic'
            break
          ;;
         "wac124")
            echo "Building image for Netgear WAC124"
            RELEASE='https://downloads.openwrt.org/releases/24.10.6/targets/ramips/mt7621/openwrt-imagebuilder-24.10.6-ramips-mt7621.Linux-x86_64.tar.zst'
            DIR='openwrt-imagebuilder-24.10.6-ramips-mt7621.Linux-x86_64'
          ...
          "wa1201v2")
            ...
            RELEASE='https://downloads.openwrt.org/releases/24.10.6/targets/ath79/generic/openwrt-imagebuilder-24.10.6-ath79-generic.Linux-x86_64.tar.zst'
            DIR='openwrt-imagebuilder-24.10.6-ath79-generic.Linux-x86_64'
