...
options=("Snapshot" "18.06.9" "19.07.8" "Quit")
...
do
    case $opt in
       ...
       "18.06.9")
            ...
            ;;
        "19.07.8")
            echo "Using OpenWrt 19.07.8"
            VERSION='19.07'
            RELEASE='https://downloads.openwrt.org/releases/19.07.8/targets/x86/64/openwrt-imagebuilder-19.07.8-x86-64.Linux-x86_64.tar.xz'
            DIR='openwrt-imagebuilder-19.07.8-x86-64.Linux-x86_64'
            break
          ;;
        "Quit")
            exit 1
