...
do
    case $opt in
        "r4s")
            ...
            RELEASE='https://downloads.openwrt.org/releases/22.03.6/targets/rockchip/armv8/openwrt-imagebuilder-22.03.6-rockchip-armv8.Linux-x86_64.tar.xz'
            DIR='openwrt-imagebuilder-22.03.6-rockchip-armv8.Linux-x86_64'
        ...
        "apu2")
            ...
            RELEASE='https://downloads.openwrt.org/releases/22.03.6/targets/x86/64/openwrt-imagebuilder-22.03.6-x86-64.Linux-x86_64.tar.xz'
            DIR='openwrt-imagebuilder-22.03.6-x86-64.Linux-x86_64'
            PROFILE='generic'
            break
          ;;
         "wac124")
            echo "Building image for Netgear WAC124"
            RELEASE='https://downloads.openwrt.org/releases/22.03.6/targets/ramips/mt7621/openwrt-imagebuilder-22.03.6-ramips-mt7621.Linux-x86_64.tar.xz'
            DIR='openwrt-imagebuilder-22.03.6-ramips-mt7621.Linux-x86_64'
